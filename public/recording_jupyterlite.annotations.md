...
### Annotation: ★ Proof Point 1 — set_complexity_score {#proof-1}
---
timestamp: 75000
color: #FFD600
autopause: true
...
driverObj.highlight({
  popover: {
    title: '★ Proof Point 1: set_complexity_score',
...
### Annotation: EDA Charts {#eda-charts}
---
timestamp: 130000
---

Three charts render: sets per year, licensed-IP vs original distribution, and `set_complexity_score` across the catalog. One business question — no schema guidance — coherent analysis.
...
### Annotation: ★ Proof Point 2a — is_spare filter {#proof-2a}
---
timestamp: 225000
color: #FFD600
autopause: true
...
driverObj.highlight({
  popover: {
    title: '★ Proof Point 2a: is_spare filter',
...
### Annotation: ★ Proof Point 2b — ip_dependency_flag {#proof-2b}
---
timestamp: 275000
color: #FFD600
autopause: true
...
driverObj.highlight({
  popover: {
    title: '★ Proof Point 2b: ip_dependency_flag',
...
MLflow run completes. Feature importance confirms `ip_dependency_flag` in the top 3 predictors — promoted by the semantic layer, validated by the model.
...
### Annotation: ★ Proof Point 3 — Self-documenting catalog {#proof-3}
---
timestamp: 455000
color: #FFD600
autopause: true
...
driverObj.highlight({
  popover: {
    title: '★ Proof Point 3: Knowledge compounds',
